...
with torch.no_grad():
	eval_epoch(net, luces_test_loader, luces_preprocessing_fun, device,  criterion=criterion, scalar_logger=scalar_logger, image_logger=image_logger, test_mode=opt.test_mode, log_meshes=opt.log_meshes, multi_scale=multi_scale)
