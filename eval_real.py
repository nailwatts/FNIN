...
with torch.no_grad():
	eval_epoch(net, real_test_loader, real_preprocessing_fun, device,  criterion=None, scalar_logger=None, image_logger=image_logger, log_meshes=opt.log_meshes, multi_scale=multi_scale)
